...
if (document.documentMode || /Edge|Version\/[\d\.]+.*Safari/.test(navigator.userAgent)) {
    $('body').append('<style type="text/css">.parallax > .background-image {top:50%!important;transform:translateY(-50%)!important;-webkit-transform:translateY(-50%)!important;}</style>');
} else {
    !function () {
        function e() {
        ...
        var _, V = function () {
            ...
            }(), U = window.navigator.userAgent, G = /Edge/.test(U), J = /chrome/i.test(U) && !G,
            Q = /safari/i.test(U) && !G, Z = /mobile/i.test(U), ee = /Windows NT 6.1/i.test(U) && /rv:11/i.test(U),
            te = (J || Q || ee) && !Z;
...
function parallaxVossen() {
    function a() {
        ...
        var k,
            ...
            m = ["transform", "msTransform", "webkitTransform", "mozTransform", "oTransform"], n = a(m),
            o = "translate3d(0,", p = "px,0)",
            q = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), r = 0, s = !1, t = !0, u = 0,
            v = 0, w = 0, x = 0, y = 2.2, z = 2, A = 350, B = 1, C = 35, D = 0, E = window, F = (i(), !1), G = this;
        jQuery(document).ready(function () {
            ...
            return q = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone|Edge|MSIE|Trident\/|Version\/[\d\.]+.*Safari/i.test(navigator.userAgent || navigator.vendor || window.opera) ? jQuery(".parallax") : l && (G.vope(), G.vops()), h(a) ? void a() : void 0
        }, this.windowLoad = function () {
            q = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), r = j(), window.vossenParallax.vope()
        }, this.vops = function () {
            ...
            k = [], r = j();
            var a = i(), b = ".parallax > .background-image, .hero-slider div.slide .background-image";
    ...
    window.vossenParallax = new a, function (a, b) {
        function c(b, c, g, h) {
    ...
    var a = function (a, b, c) {
        ...
        var f = {}, g = {documentReady: [], windowLoad: []};
    ...
    !function (a, b, c) {
        ...
        return a.backgrounds = {documentReady: d}, a.components.documentReady.push(d), a;
        var d
    }(a), function (a, b, c) {
    }
}
...
!function (a) {
    ...
    function b(a, b, c) {
        ...
        return e.prototype._create = function () {
            ...
            var d = b ? "Width" : "Height", e = this.size["outer" + d],
                f = this.layout[b ? "columnWidth" : "rowHeight"], g = this.layout.size["inner" + d];
...
function vossenGoogleMaps() {
    function g(b, e) {
        var f = new google.maps.LatLng(b, e),
            g = {zoom: d, center: f, mapTypeId: google.maps.MapTypeId.ROADMAP, scrollwheel: !1, mapTypeControl: !1},
            h = new google.maps.Map(document.getElementById("vossen-map"), g),
            i = '<div class="vossen-map-info">' + c + "</div>", j = new google.maps.InfoWindow({content: i}),
        ...
        }, {featureType: "water", elementType: "labels.text.stroke", stylers: [{color: "#fef7f7"}]}], m = [{
            featureType: "all",
            elementType: "labels.text.fill",
        ...
        if ("light" === a.data("map-style")) var n = new google.maps.StyledMapType(l); else if ("dark" === a.data("map-style")) var n = new google.maps.StyledMapType(m); else var n = new google.maps.StyledMapType;
        h.mapTypes.set("map_style", n), h.setMapTypeId("map_style")
    }

    var a = $("#vossen-map"), b = a.data("map-address"), c = a.data("marker-info"), d = a.data("map-zoom"),
        e = a.data("map-height");
    a.css("height", e);
    (new google.maps.Geocoder).geocode({address: b}, function (a, b) {
        if (b == google.maps.GeocoderStatus.OK) {
            var c = a[0].geometry.location.lat(), d = a[0].geometry.location.lng();
            g(c, d)
        }
    })
}
...
function initVossenMaps() {
    var a = $("#vossen-map").data("maps-api-key"), b = document.createElement("script");
    b.src = "https://maps.googleapis.com/maps/api/js?key=" + a + "&callback=vossenGoogleMaps", document.body.appendChild(b)
}
...
function vosResize() {
    ...
    a / b > 16 / 9 ? (player.setSize(a, a / 16 * 9), $("#vossen-youtube").css({left: "50%"})) : (player.setSize(b / 9 * 16, b), $("#vossen-youtube").css({left: -($("#vossen-youtube").outerWidth() - a) / 2}))
}
...
if ($("#vossen-youtube").length) {
    ...
    var vosVideoId = $("#vossen-youtube").attr("data-youtube-video-id"), player
}
